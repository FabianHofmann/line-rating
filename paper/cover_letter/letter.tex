...
\def\Where{\hspace{-1.2mm}\textbf{\color{tubred}%{tubred}
	Department of Digital\\Transformation in Energy Systems,\\ TU Berlin
}}
...
\begin{document}
 ...
 \begin{letter}{To whom it may concern}
		...
		The model comprises a high temporal and spatial resolution allowing us to model DLR very precisely.
		The paper appears at an important time as  politicians and Transmission System Operators (TSOs) have recognized the problem of lacking transmission capacities when integrating high renewable shares in Germany.
		Hence, in current reports from the German government, TSOs and also scientists, DLR is discussed as promising measures to relief the transmission grid.
		The model presented in the paper shows significant cost savings of 4~bn€ per year for the power system with DLR.
		Furthermore, the paper finds a significant reduction grid congestion and renewable curtailment.
