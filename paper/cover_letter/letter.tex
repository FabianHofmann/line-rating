...
\begin{document}
 ...
 \begin{letter}{To whom it may concern}
		...
		In our work, we present the first large scale optimization model assessing the benefits of Dynamic Line Rating (DLR) in Germany.
		The model comprises a high temporal and spatial resolution,	as well as a high level of detail, enabling a realistic representation of the system dynamics.
		...
		Our analysis confirms that integrating DLR leads overall system benefits.
		Besides significant cost savings of 4~bn€ per year for the German power system, DLR leads to significant reduction of grid congestion and renewable curtailment.

		The paper was read by Prof. Tom Brown, an energy system expert and native tongue speaker, as well as from Rena Kuwahata from Ampacimon, an expert on transmission lines and DLR applications.
