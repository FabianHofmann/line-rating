...
<<<<<<< HEAD
		In our work, we present the first large-scale optimization model assessing the benefits of Dynamic Line Rating (DLR) in the German power system.
		To enable a realistic representation of the system dynamics, the model comprises a high temporal and spatial resolution as well as a high level of detail.
		The paper appears at an important time as  politicians and Transmission System Operators (TSOs) have recognized the problem of lacking transmission capacities when moving towards high renewable shares in Germany.
		Hence, in reports from policy makers, TSOs and researchers, DLR is considered as a promising measure to relief the transmission grid.
		Our analysis not only confirms the transmission system benefits but also shows how the implementation of DLR affects the optimal system design. By better integrating wind power resources, especially offshore, DLR leads to significant cost savings of \euro{}4~ billion per year, mainly due to the reduced need for cost-driving energy storage. This result is of particular importance for German and European network operators and the research community.
=======
