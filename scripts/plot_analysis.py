...
def plot_capacity_bar(ax, networks):
    ...
    ax.set_xticklabels(list(slr.carriers.nice_name.loc[capacities.index]), rotation=45)
...
def plot_curtailment_bar(ax, networks):
    ...
    ax.set_xticklabels(list(slr.carriers.nice_name.loc[curtailment.index]), rotation="horizontal")
...
if __name__ == "__main__":
    ...
    sns.set_context("paper", rc={"font.size":12,"axes.titlesize":20,"axes.labelsize":16, "xtick.labelsize":12, "ytick.labelsize":12})   
